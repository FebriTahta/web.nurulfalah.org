					...
					<ul class="mint-funcz">
						<li>
							<a href="#" title="" class="search-btn">
								<img src="{{asset('assets2/images/icon3.png')}}" alt="">
							</a>
						</li>
						<li>
							<a href="#" title="">
								<img src="{{asset('assets2/images/icon4.png')}}" alt="">
							</a>
						</li>
						<li>
							<a href="#" title="">
								<img src="{{asset('assets2/images/icon5.png')}}" alt="">
					...
					<div class="col-lg-6">
						<div class="banner-content">
							...
							<ul class="banz-list wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="700ms">
								<li>
									<div class="mint-fzt">
										<img src="{{asset('assets2/images/icon1.png')}}" alt="">
										<div class="bzn-csd">
											<h5>Durability</h5>
								...
								<li>
									<div class="mint-fzt">
										<img src="{{asset('assets2/images/icon2.png')}}" alt="">
										<div class="bzn-csd">
		...
		<footer>
			<div class="container">
				...
				<div class="bottom-footer">
					<div class="ft-logo">
						<img src="assets2/images/ft-logo.png" alt="">
					</div><!--ft-logo end-->
					<ul class="btm-links">
