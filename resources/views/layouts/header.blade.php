...
<head>
    ...
    <link rel="apple-touch-icon" type="image/x-icon"
        href="{{ asset('yes/img/apple-touch-icon-57x57-precomposed.png') }}">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72"
        href="{{ asset('yes/img/apple-touch-icon-72x72-precomposed.png') }}">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114"
        href="{{ asset('yes/img/apple-touch-icon-114x114-precomposed.png') }}">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144"
        href="{{ asset('yes/img/apple-touch-icon-144x144-precomposed.png') }}">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('yes/revolution-slider/fonts/font-awesome/css/font-awesome.css') }}">
    ...
    @if (Request::routeIs('post.detail'))
        <header class="header_in clearfix element_to_stick sticky_horizontal">
            <div class="container">
                <div id="logo">
                    <a href="/">
                        <img src="{{ asset('yes/img/nf_logo.png') }}" width="150" height="52" alt=""
                            class="logo_sticky">
                    </a>
                </div>
                ...
                <nav class="main-menu">
                    <div id="header_menu">
                        ...
                        <a href="index.html"><img src="{{ asset('yes/img/nf_logo_white.png') }}" width="162"
                                height="62" alt=""></a>
                    </div>
                    <ul>
                        <li class="submenu">
    ...
    @else
        <header class="header clearfix element_to_stick">
            <div class="container">
                <div id="logo">
                    <a href="index.html">
                        <img src="{{ asset('yes/img/nf_logo_white.png') }}" width="150" height="52" alt=""
                            class="logo_normal">
                        <img src="{{ asset('yes/img/nf_logo.png') }}" width="150" height="52" alt=""
                            class="logo_sticky">
                    </a>
