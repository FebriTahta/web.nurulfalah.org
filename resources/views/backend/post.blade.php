                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card">
                            ...
                            <div class="body text-center" id="dynamicAddRemove">
                                {{-- <button name="add" type="button" id="dynamic-ar" class="btn btn-sm btn-primary"
                                    style="margin-bottom: 10px"><i class="fa fa-plus"></i> Add New</button>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">Upload</span>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" onchange="showPreview1(event);" name="imageposting_id[]"
                                            class="custom-file-input" id="imageposting1" multiple>
                                        <label class="custom-file-label" for="imageposting1">Pilih Image</label>
                                    </div>
                                </div>
                                <div class="preview2">
                                    <img style="max-width: 100%" id="preview2">
                                </div> --}}
